...
<form class="form-horizontal" method="POST" action="{{ route('register') }}">
    {{ csrf_field() }}
          ...
          <div class="form-group has-icon-left form-control-comapny form-group{{ $errors->has('comapny') ? ' has-error' : '' }}">
              <label class="sr-only" for="inputName">Company name</label>
              <input type="text" class="form-control form-control-lg" id="companyName" name="name" value="{{ old('name') }}" placeholder="Company name">
